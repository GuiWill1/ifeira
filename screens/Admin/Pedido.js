    ...
    return (
      ...
      <Container style={{ marginLeft: 8, marginRight: 8 }}>
        ...
        <ScrollView>
          ...
          <Button style={{ justifyContent: 'center', margin: 10, marginHorizontal: '20%' }} bordered success onPress={() => this.FinalizarPedido()} >
            <Text style={{ fontWeight: 'bold', marginLeft: -5 }}>Marcar como entregue</Text>
          </Button>
